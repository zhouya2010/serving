...
Status SessionBundlePredict(const RunOptions& run_options, ServerCore* core,
  ...
  std::cout << "Validate signatures time cost: "<<timeDiff<<std::endl;
  ...
  std::cout << "Verify and prepare input time cost: "<<timeDiff<<std::endl;
  ...
  timeDiff = getCurrentTime() - tmpcal_ptr;
  std::cout << "Prepare run target time cost: "<<timeDiff<<std::endl;
  ...
  timeDiff = getCurrentTime() - tmpcal_ptr;
  std::cout << "output tensors specified time cost: "<<timeDiff<<std::endl;
  ...
  timeDiff = getCurrentTime() - tmpcal_ptr;
  std::cout << "Run session time cost: "<<timeDiff<<std::endl;
  ...
  timeDiff = getCurrentTime() - tmpcal_ptr;
  std::cout << "SessionBundlePredict time cost: "<<timeDiff<<std::endl;
